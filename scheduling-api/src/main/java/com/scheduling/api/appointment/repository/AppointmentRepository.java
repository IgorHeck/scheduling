...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    @Query("SELECT a FROM Appointment a WHERE a.company.id = :companyId " +
           ...
           "AND a.startAt BETWEEN :start AND :end ORDER BY a.startAt")
    Page<Appointment> findByCompanyAndProfessionalInPeriod(
    ...
    @Query("SELECT a FROM Appointment a WHERE a.company.id = :companyId " +
           "AND a.status = :status AND a.professional.id = :professionalId")
    List<Appointment> findPendingByCompanyAndProfessional(
            @Param("companyId") Long companyId,
